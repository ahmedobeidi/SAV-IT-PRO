 ...
 */
final class Version20260321135650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket_delivery DROP INDEX idx_ticket_delivery_recipient, ADD INDEX idx_ticket_delivery_recipient (recipient_email)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket_delivery DROP INDEX idx_ticket_delivery_recipient, ADD INDEX idx_ticket_delivery_recipient (recipient_email(250))');
