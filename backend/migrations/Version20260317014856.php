 ...
 */
final class Version20260317014856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket DROP content_hash, DROP render_snapshot, DROP is_current, DROP is_stale, DROP is_frozen, DROP invalidated_at, DROP last_viewed_at');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD content_hash VARCHAR(64) NOT NULL, ADD render_snapshot JSON NOT NULL, ADD is_current TINYINT DEFAULT 1 NOT NULL, ADD is_stale TINYINT DEFAULT 0 NOT NULL, ADD is_frozen TINYINT DEFAULT 0 NOT NULL, ADD invalidated_at DATETIME DEFAULT NULL, ADD last_viewed_at DATETIME DEFAULT NULL');
    }
}
