 ...
 */
final class Version20260305114355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE issue ADD equipment_type_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_12AD233EB337437C ON issue (equipment_type_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_12AD233EB337437C ON issue');
        $this->addSql('ALTER TABLE issue DROP equipment_type_id');
