 ...
 */
final class Version20260316022355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE business_sequence (id INT AUTO_INCREMENT NOT NULL, seq_type VARCHAR(50) NOT NULL, seq_year INT NOT NULL, last_number INT NOT NULL, UNIQUE INDEX uniq_business_sequence_type_year (seq_type, seq_year), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE repair_order ADD reference VARCHAR(30) NOT NULL');
        ...
        $this->addSql('ALTER TABLE ticket ADD storage_path VARCHAR(255) NOT NULL, ADD version INT NOT NULL, ADD sent_at DATETIME DEFAULT NULL, DROP content');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE business_sequence');
        ...
        $this->addSql('DROP INDEX uniq_repair_order_reference ON repair_order');
        $this->addSql('ALTER TABLE repair_order DROP reference');
        ...
        $this->addSql('ALTER TABLE ticket ADD content LONGBLOB NOT NULL, DROP storage_path, DROP version, DROP sent_at');
    }
}
