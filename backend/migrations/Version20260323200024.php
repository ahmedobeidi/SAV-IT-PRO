 ...
 */
final class Version20260323200024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE refresh_token ADD token_hash VARCHAR(64) NOT NULL, DROP token');
        ...
        $this->addSql('ALTER TABLE ticket ADD CONSTRAINT FK_97A0ADA3E4071493 FOREIGN KEY (repair_order_id) REFERENCES repair_order (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_C74F2195B3BC57DA ON refresh_token');
        $this->addSql('ALTER TABLE refresh_token ADD token VARCHAR(128) NOT NULL, DROP token_hash');
