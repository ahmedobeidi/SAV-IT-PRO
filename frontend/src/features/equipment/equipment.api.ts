...
export const equipmentApi = {
  ...
  // BRANDS (par type)
  async listBrands(typeId: number, params: { search?: string; page?: number; limit?: number }): Promise<Paginated<EquipmentBrandRead>> {
  ...
  // MODELS (par brand)
  async listModels(brandId: number, params: { search?: string; page?: number; limit?: number }): Promise<Paginated<EquipmentModelRead>> {
